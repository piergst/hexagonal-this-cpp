...
{
public:
    PoetryReader(): m_poetryLibrary{std::make_shared<HardCodedPoetryLibrary>()}{}

    PoetryReader(std::shared_ptr<IObtainPoems> poetryLibrary): m_poetryLibrary{poetryLibrary} {}
